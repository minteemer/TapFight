...
class GamePreferencesDAO private constructor(preferences: SharedPreferences) : BaseSharedPreferences(preferences), GamePreferencesRepository {
    companion object {
        private const val PREFERENCES_FILE_NAME = "game_preferences"

        val instance: GamePreferencesDAO by lazy { GamePreferencesDAO(TapFightApplication.instance.getSharedPreferences(PREFERENCES_FILE_NAME, Context.MODE_PRIVATE)) }
    }
